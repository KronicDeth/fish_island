...
describe CasesController do
  ...
  def valid_attributes
    FactoryGirl.attributes_for(:case)
  end

  describe "GET index" do
    it "assigns all cases as @cases" do
      instance = Case.create! valid_attributes

      get :index

      assigns(:cases).should eq([instance])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested case as @case" do
      ...
      assigns(:case).should eq(instance)
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      ...
      it "re-renders the 'new' template" do
        ...
        Case.any_instance.stub(:errors) { errors }
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested case" do
        ...
        Case.any_instance.should_receive(:update_attributes).with({'these' => 'params'})

        put :update, :id => instance.id, :case => {'these' => 'params'}
      end

      it "assigns the requested case as @case" do
        instance = Case.create! valid_attributes

        put :update, :id => instance.id, :case => valid_attributes
    ...
    describe "with invalid params" do
      it "assigns the case as @case" do
        ...
        put :update, :id => instance.id, :case => {}
